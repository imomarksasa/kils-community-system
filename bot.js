...
antispam(client, {
  ...
  interval: 10000, // مقدار الوقت قبل حصول باند
  warningMessage: "**وقف اسبام.**", 
  roleMessage: "**تم اعطاء ميوت بسبب السبام !**!", 
  roleName: "Muted", // اسم رتبة الميوت
  maxDuplicatesWarning: 12, // عدد الرسايل الي قبل التحذيرات
  maxDuplicatesBan: 17, // عدد الرسايل الي يقدر المستخدم يرسلها قبل الميوت

...
antispam(client, {
  ...
  maxBuffer: 15, // الحد الأقصى المسموح به من الرسائل لإرسالها في الفاصل الزمني قبل الحصول على ميوت.
  interval: 19000, // مقدار الوقت قبل حصول باند
  warningMessage: "", 
  roleMessage: "**", 
  roleName: "Muted", // اسم رتبة الميوت
  maxDuplicatesWarning: 20, // عدد الرسايل الي قبل التحذيرات
  maxDuplicatesBan: 25, // عدد الرسايل الي يقدر المستخدم يرسلها قبل الميوت
